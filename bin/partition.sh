...
#
# Utility script to deal with partitions...
#
...
menu() {
    echo
    echo "------------------------------------------"
    echo "Partition Operations"
    echo "------------------------------------------"
    echo
    echo "  Partition Operations:"
    echo "    ap)  Add partition to VM"
    echo "    rp)  Remove partition from VM"
    echo "    dp)  Delete partition"
    echo "    lp)  List partitions"
    echo
    echo "  e) Exit"
    echo
